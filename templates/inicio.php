<div id="wrapper">
	<div class="HeadCont">
		<div class="TopNav">
			<div class="container">
				<nav class="navbar-right MenuTop">
					<p><a class="flatBTn" href="Carrer">Carrers</a>&nbsp&nbspI&nbsp&nbsp<a class="flatBTn" href="">Español</a> - <a class="flatBTn" href="">Inglés</a>
				</nav>
			</div>
		</div>
        <header>
